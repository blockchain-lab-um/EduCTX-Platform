	...
	proto.Ca.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				ethaddres: jspb.Message.getFieldWithDefault(msg, 3, ''),
			};
...
/**
 * optional string ethAddres = 3;
 * @return {string}
 */
proto.Ca.prototype.getEthaddres = function () {
	return /** @type {string} */ (
 ...
 * @return {!proto.Ca} returns this
 */
proto.Ca.prototype.setEthaddres = function (value) {
